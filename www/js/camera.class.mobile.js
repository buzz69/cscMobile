		...
		this.getPanel = function(container) {
				...
				//panneau de controle
					...
					if(Ccontrollable==1){		//si pilotable
						...
						controlPanel+='		<tr><td></td><td><div class="ctrlbtn" command="moveConUp" flip="moveConDown" mirror="moveConUp" mirrorflip="moveConDown" data-role="button" data-icon="arrow-u" data-iconpos="notext" style="cursor:pointer"></div></td><td></td></tr>';
						...
						controlPanel+='	</table>';
						*/
						controlPanel+='<br><div style="width:148px;height:148px;padding:0;margin=0">';
						controlPanel+='		 <div style="float:left;width:49px;height:49px"><img src="controls/Slice.png" width="49" height="49" alt=""></div><div style="float:left;width:50px;height:49px"><img src="controls/Slice-02.png" width="50" height="49" alt="" class="ctrlbtn" command="moveConUp" flip="moveConDown" mirror="moveConUp" mirrorflip="moveConDown" onmousedown="$(this).attr(\'src\',\'controls/Slice-02-active.png\');" onmouseup="$(this).attr(\'src\',\'controls/Slice-02.png\');" style="cursor:pointer"></div><div style="float:left;width:49px;height:49px"><img src="controls/Slice-03.png" width="49" height="49" alt=""></div>';
						controlPanel+='		 <div style="float:left;width:49px;height:50px"><img src="controls/Slice-04.png" width="49" height="50" alt="" class="ctrlbtn" command="moveConLeft" flip="moveConLeft" mirror="moveConRight" mirrorflip="moveConRight" onmousedown="$(this).attr(\'src\',\'controls/Slice-04-active.png\');" onmouseup="$(this).attr(\'src\',\'controls/Slice-04.png\');" style="cursor:pointer"></div><div style="float:left;width:50px;height:50px"><img src="controls/Slice-05.png" width="50" height="50" alt="" onclick="controlCamera(\''+Cid+'\',\'presetHome\');return false;" style="cursor:pointer" title="RAZ"></div><div style="float:left;width:49px;height:50px"><img src="controls/Slice-06.png" width="49" height="50" alt="" class="ctrlbtn" command="moveConRight" flip="moveConRight" mirror="moveConLeft" mirrorflip="moveConLeft" onmousedown="$(this).attr(\'src\',\'controls/Slice-06-active.png\');" onmouseup="$(this).attr(\'src\',\'controls/Slice-06.png\');" style="cursor:pointer"></div>';
						controlPanel+='		 <div style="float:left;width:49px;height:49px"><img src="controls/Slice-07.png" width="49" height="49" alt=""></div><div style="float:left;width:50px;height:49px"><img src="controls/Slice-08.png" width="50" height="49" alt="" class="ctrlbtn" command="moveConDown" flip="moveConUp" mirror="moveConDown" mirrorflip="moveConUp" onmousedown="$(this).attr(\'src\',\'controls/Slice-08-active.png\');" onmouseup="$(this).attr(\'src\',\'controls/Slice-08.png\');" style="cursor:pointer"></div><div style="float:left;width:49px;height:49px"><img src="controls/Slice-09.png" width="49" height="49" alt=""></div>';
						controlPanel+='	   </div>';
